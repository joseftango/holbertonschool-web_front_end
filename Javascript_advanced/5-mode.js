...
function main() {
	...
	spooky.onclick = changeMode(9, 'bold', 'uppercase', 'pink', 'green');
	...
	darkMode.onclick = changeMode(12, 'bold', 'capitalize', 'black', 'white');

	const screamMode = document.createElement('button');
	screamMode.textContent = 'Scream mode';
	document.body.appendChild(screamMode);

	screamMode.onclick = changeMode(12, 'normal', 'lowercase', 'white', 'black');
}
